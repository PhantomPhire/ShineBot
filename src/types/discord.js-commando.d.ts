...
declare module 'discord.js-commando' {
	...
	export class Command {
		...
		public reload(): void;
		public run(message: CommandMessage, args: {} | string | string[], fromPattern: boolean): Promise<Message | Message[] | void>;
	...
	export class CommandoClient extends Client {
		...
		public on(event: 'commandError', listener: (command: Command, message: CommandMessage, args: {} | string | string[], fromPattern: boolean) => void): this;
	...
	export class CommandRegistry {
		...
		public registerTypesIn(options: string | Object): CommandRegistry;
	...
	export class SQLiteProvider extends SettingProvider {
		public constructor(db: Object);

		public readonly client: CommandoClient;
		public db: Object;
		private deleteStmt: Object;
		private insertOrReplaceStmt: Object;
